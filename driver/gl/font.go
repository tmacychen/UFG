...
func (f *font) align(rect math.Rect, size math.Size, ascent int, h framework.HorizontalAlignment, v framework.VerticalAlignment) math.Point {
...
func (f *font) DrawRunes(ctx *context, runes []rune, offsets []math.Point, col tools.Color, ds *drawState) {
...
func (f *font) Measure(fl *framework.TextBlock) math.Size {
...
func (f *font) Layout(fl *framework.TextBlock) (offsets []math.Point) {
	sizeDips := math.Size{}

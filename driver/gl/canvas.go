...
func (c *canvas) Clear(color tools.Color) {
...
func (c *canvas) DrawCanvas(cc framework.Canvas, offsetDips math.Point) {
	if cc == nil {
...
func (c *canvas) DrawRunes(f framework.Font, r []rune, p []math.Point, col tools.Color) {
	if f == nil {
...
func (c *canvas) DrawLines(lines framework.Polygon, pen tools.Pen) {
...
func (c *canvas) DrawPolygon(poly framework.Polygon, pen tools.Pen, brush tools.Brush) {
...
func (c *canvas) DrawRect(r math.Rect, brush tools.Brush) {
...
func (c *canvas) DrawRoundedRect(r math.Rect, tl, tr, bl, br float32, pen tools.Pen, brush tools.Brush) {
	if tl == 0 && tr == 0 && bl == 0 && br == 0 && pen.Color.A == 0 {
		c.DrawRect(r, brush)
		return
	}
	p := framework.Polygon{
		framework.PolygonVertex{Position: r.TL(), RoundedRadius: tl},
		framework.PolygonVertex{Position: r.TR(), RoundedRadius: tr},
		framework.PolygonVertex{Position: r.BR(), RoundedRadius: br},
		framework.PolygonVertex{Position: r.BL(), RoundedRadius: bl},
	}
	c.DrawPolygon(p, pen, brush)
}

func (c *canvas) DrawTexture(t framework.Texture, r math.Rect) {
	if t == nil {
